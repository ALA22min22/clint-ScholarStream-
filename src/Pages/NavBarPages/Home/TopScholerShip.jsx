...
const TopScholerShip = () => {
    ...
    return (
        <div>
            <div>
                {
                    topSchol.map(top => <div key={top._id} class="group before:hover:scale-95 before:hover:h-72 before:hover:w-80 before:hover:h-44 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-sky-200 via-orange-200 to-orange-700 before:absolute before:top-0 w-80 min-h-72 relative  flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden bg-base-300 border">

                        <div >
                            <p className='badge badge-secondary badge-outline '>{top.scholarshipCategory}</p>
                        </div>

                        <div class="w-28 h-28  mt-6 rounded-full border-4 border-slate-50 z-10 group-hover:scale-150 group-hover:-translate-x-24  group-hover:-translate-y-20 transition-all duration-500">
                            <img src={top.universityImage} className='rounded-full' alt="" />
                        </div>
                        <div class="z-10  group-hover:-translate-y-10 transition-all duration-500">
                            ...
                            <div class="flex items-center text-base-content/70">
                                    ...
                                    <span>{top.country}, {top.city}</span>
                                </div>
                            <div class="flex items-center text-base-content/70">

        ...
        <div id='all-scho' className=' p-2'>
            {/* <section className='flex flex-col md:flex-row lg:flex-row justify-between items-center mt-10 '>
                ...
                <motion.h3 initial={{ opacity: 0, y: 20 }}
                    ...
                    whileHover={{ scale: 1.05, color: "#f97316" }} className='text-5xl font-bold  text-center text-primary'>All Scholersiph</motion.h3>

                <div className="dropdown dropdown-hover ">
                    <div tabIndex={0} role="button" className="btn btn-primary text-white m-1">Sort Options</div>

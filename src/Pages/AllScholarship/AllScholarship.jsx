...
const AllScholarship = () => {
    ...
    return (
        <div>
            <div>
                <h3>All scholerShiph</h3>
            </div>

            {
                allScho.map(schol => <div key={schol._id} class="card w-96 bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300 card-bordered border-base-200">
                <figure class="h-48 relative overflow-hidden">
                    <img src={schol.universityImage} />
                </figure>
